        ...
        <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="rounded-lg border border-primary/20 bg-primary/5 p-4 text-center">
            ...
            <p className="text-muted-foreground text-sm">
              Exportieren Sie Ihre Transaktionen aus Kontist oder Holvi als CSV-Datei und laden Sie
              diese hier hoch.
            </p>
          </div>
          ...
          {isProcessing ? (
            ...
            <>
              ...
              <p className="mx-auto mb-6 max-w-md text-muted-foreground">
                Laden Sie Ihre Kontist oder Holvi CSV-Datei hoch, um automatisch Transaktionen zu
                kategorisieren und Ihre EÜR zu erstellen.
              </p>
              <input
                accept=".csv"
                ...
                type="file"
              />
              <Button asChild className="focus-ring" disabled={isProcessing} size="lg">
