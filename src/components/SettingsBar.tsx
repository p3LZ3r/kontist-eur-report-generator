    ...
    return (
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-6">
            ...
            <div className="flex items-center gap-2">
                <label htmlFor="kleinunternehmer-select" className="text-sm text-foreground whitespace-nowrap">
                ...
                >
                    <SelectTrigger id="kleinunternehmer-select" className="w-24 focus-ring bg-white">
                        <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
            ...
            <div className="flex items-center gap-2">
                <label htmlFor="skr-select" className="text-sm text-foreground whitespace-nowrap">
                    Kontenrahmen:
                </label>
                <Select value={currentSkr} onValueChange={(value: 'SKR03' | 'SKR04' | 'SKR49') => onSkrChange(value)}>
