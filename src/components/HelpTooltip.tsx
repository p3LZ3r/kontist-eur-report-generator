			...
			{isVisible && (
				<div className={`absolute z-50 ${getPositionClasses()}`}>
					<div className="bg-white border border-border rounded-lg p-5 w-96">
						...
						{/* Arrow */}
						<div
							className={`absolute w-2 h-2 bg-white border-${position === "top" ? "b" : position === "bottom" ? "t" : position === "left" ? "r" : "l"} border-${position === "top" ? "b" : position === "bottom" ? "t" : position === "left" ? "r" : "l"}-border transform rotate-45 ${
								position === "top"
