...
import { getCategoriesForSkr, skr04Categories, elsterMapping } from '../utils/categoryMappings';
...
describe('Category Mappings - SKR Categorization Engine', () => {
    ...
    describe('Category Edge Cases', () => {
        ...
        it('should ensure all income categories have type "income"', () => {
            const incomeCategories = Object.entries(skr04Categories)
        ...
        it('should ensure all expense categories have type "expense"', () => {
            const expenseCategories = Object.entries(skr04Categories)
                .filter(([key]) => key.startsWith('expense_') && !key.includes('tax_free_income'));
        ...
        it('should ensure all private categories have type "private" and VAT 0', () => {
            const privateCategories = Object.entries(skr04Categories)
    ...
    describe('ELSTER Field Mapping Completeness', () => {
        it('should have ELSTER mappings for all business-relevant categories', () => {
            const businessCategories = Object.entries(skr04Categories)
        ...
        it('should map to valid ELSTER field numbers', () => {
            const validElsterFields = [
                '12', '15', '16', '19', '20', // Income fields
                '27', '29', '30', '31', '32', '33', '34', '35', '36', '37', // Basic expense fields
                '44', '55', '56', '62', '63', '64', '65', '66', // Specific expense fields
                '78', '79', '80', '81', '84', '85', '91' // Special calculation fields
            ];
