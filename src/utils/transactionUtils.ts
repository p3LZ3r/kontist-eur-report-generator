...
const CATEGORIZATION_RULES = [
  ...
  {
    type: "income",
    patterns: ["erstattung", "rückerstattung", "refund", "rückvergütung"],
    category: "income_refunds",
  },
  {
    type: "income",
    patterns: ["rg ", "rechnung", "invoice"],
    category: "income_services_19",
  },
  {
    type: "income",
    patterns: ["anzahlung", "prepayment"],
    category: "income_prepayments",
  },
  {
    type: "income",
    patterns: ["waren", "verkauf"],
    category: "income_goods_19",
  },
  ...
  {
    type: "expense",
    patterns: ["kontist", "holvi", "payment services"],
    category: "expense_banking",
    field: "counterparty",
  },
  ...
  {
    type: "expense",
    patterns: ["gewerbesteuer", "gst"],
    category: "expense_taxes_trade",
  },
  ...
  {
    type: "expense",
    patterns: ["software", "lizenz", "adobe", "microsoft"],
  ...
  {
    type: "expense",
    patterns: ["tank", "sprit", "kfz"],
    category: "expense_vehicle_fuel",
  },
  {
    type: "expense",
    patterns: ["shell", "esso", "aral"],
    category: "expense_vehicle_fuel",
    field: "counterparty",
  },
  ...
  {
    type: "expense",
    patterns: ["telekom", "vodafone", "1&1"],
    category: "expense_phone",
    field: "counterparty",
  },
  ...
  {
    type: "expense",
    patterns: ["website", "wartung"],
    category: "expense_maintenance_website",
  },
  {
    type: "expense",
    patterns: ["google", "facebook", "meta", "instagram"],
    category: "expense_advertising_online",
    field: "counterparty",
  },
  {
    type: "expense",
    patterns: ["werbung", "marketing"],
    category: "expense_advertising_print",
  },

  // Office supplies
  {
    type: "expense",
    patterns: ["büro", "office"],
    category: "expense_office_supplies",
    field: "both",
    condition: (betrag: number) => betrag < 50,
  },
  {
    type: "expense",
    patterns: [],
    category: "expense_office_equipment",
    condition: (betrag: number) => betrag >= 50 && betrag <= 800,
  },
];
